...
export default function MenuNovo() {
  ...
  const renderMobileMenu = (
    ...
    >
      <Nav>
      <MenuItem>
        <Link className = "linkRecolher" to="/dashboard">Dashboard</Link>
      </MenuItem>

      <MenuItem>
        <Link className = "linkRecolher" to="/cadastro/produto">Cadastro de produto</Link>
     </MenuItem>
     <MenuItem>
       <Link className = "linkRecolher" to="/cadastro/empresa">Cadastro de Empresas</Link>
     </MenuItem>
      <MenuItem>
       <Link className = "linkRecolher" to="/relatorio">Relatórios</Link>
      </MenuItem>
      <MenuItem>
       <Link className = "linkRecolher" to="/transferencia">Transferências</Link>
     </MenuItem>
     <MenuItem>
     <Button className ="botaoRecolher" onClick={signOut}>sair</Button>
     </MenuItem>
     </Nav>
     </Menu>
...
export default function Menu() {
  ...
  return (
    ...
    <div className="root">
      <AppBar className = "header" position="static">
        <Toolbar>
        <IconButton><Avatar className = "avatar">
        <img className = "logo" src={logo} alt="logo"/>
        </Avatar></IconButton>
        <Link className = "link" to="/dashboard">Dashboard</Link>
        <Link className = "link" to="/cadastro/produto">Cadastro de produto</Link>
